    ...
    <svg xmlns='http://www.w3.org/2000/svg' width='500' height='200'>
      ...
      >
        <animate
          ...
          repeatCount='indefinite'
          dur='12s'
          values='M0,200 C100,100 160,80 200,106 C200,106 260,140 300,200 L200,200 Z;M0,200 C90,80 140,90 200,110 C200,110 260,130 300,200 L200,200 Z;M0,200 C80,120 120,100 220,100 C220,100 290,96 300,200 L200,200 Z;M0,200 C90,80 140,90 200,110 C200,110 260,130 300,200 L200,200 Z;M0,200 C100,100 160,80 200,106 C200,106 260,140 300,200 L200,200 Z'
        />
      </path>
      <path
        d='M0,150 C50,200 150,200 200,150 S350,100 400,150 S500,200 500,150 V200 H0 Z'
